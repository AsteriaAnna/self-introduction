  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        >
          <p
            className={`text-xs sm:text-sm tracking-[0.3em] uppercase mb-4 sm:mb-8 text-gray-400 ${theme === 'dark' ? 'text-gray-500' : 'text-gray-400'}`}
          >
            {t('hero.hello')}
          </p>
          <h1
            className={`text-3xl xs:text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extralight tracking-tight mb-4 sm:mb-8 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}
          >
            {config.name}
          </h1>
          <p
            className={`text-base sm:text-xl font-light mb-8 sm:mb-12 ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}
          >
            {config.title}
          </p>
          <p
            className={`text-sm sm:text-base leading-loose max-w-xl mx-auto mb-12 sm:mb-16 px-2 ${theme === 'dark' ? 'text-gray-500' : 'text-gray-400'}`}
          >
            {config.bio}
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            {config.email && (
              ...
              >
                {t('hero.contact')}
                <span
                  className={`absolute -bottom-1 left-0 w-0 h-0.5 transition-all duration-300 ${theme === 'dark' ? 'bg-white' : 'bg-gray-900'} hover:w-full`}
                />
                <span
                  className={`absolute -bottom-1 left-0 w-full h-0.5 ${theme === 'dark' ? 'bg-white/20' : 'bg-gray-900/20'}`}
                />
              </a>
            )}
            <a
      ...
      <div className="absolute bottom-16 left-1/2 transform -translate-x-1/2 animate-bounce">
        <svg
          className={`w-5 h-5 ${theme === 'dark' ? 'text-gray-700' : 'text-gray-300'}`}
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
...
function LifeAttitudeSection() {
  ...
  return (
    <section id="attitude" className="py-16 sm:py-24 md:py-32 px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 gap-8 sm:gap-12">
          {attitudes.map((item, index) => (
            ...
            >
              ...
              <p className="text-xs sm:text-sm text-gray-400 dark:text-gray-500">{item.desc}</p>
            </div>
          ))}
        </div>
      </div>
...
function AbilityCloudSection() {
  ...
  return (
    <section id="ability-cloud" className="py-16 sm:py-24 md:py-32 px-4 sm:px-6">
...
function ExploreDirectionsSection() {
  ...
  return (
    <section id="explore" className="py-16 sm:py-24 md:py-32 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        <div
          className={`text-center mb-12 sm:mb-16 md:mb-20 transition-all duration-1000 transform ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
...
function SkillCloudSection() {
  ...
  return (
    <section id="skill-cloud" className="py-16 sm:py-24 md:py-32 px-4 sm:px-6">
      <div className="max-w-5xl mx-auto">
        <div
          className={`text-center mb-10 sm:mb-16 transition-all duration-1000 transform ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
...
function KnowledgeGraphSection() {
  ...
  return (
    <section id="graph" className="py-16 sm:py-24 md:py-32 px-4 sm:px-6">
    ...
    <section id="contact" className="py-16 sm:py-24 md:py-32 px-4 sm:px-6">
      <div className="max-w-2xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-gray-400 dark:text-gray-500 text-xs sm:text-sm">{t('contact.cta')}</p>
        </div>
      </div>
    </section>
  );
...
export default function Home() {
  ...
  return (
    <div
      className={`min-h-screen overflow-x-hidden ${theme === 'dark' ? 'bg-gray-950' : 'bg-white'}`}
    >
      <Navbar />
      <main>
        <HeroSection />
